...
<div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-4">
    <div>
        <div class="text-muted small mb-1">
            <a href="{{ route('admin.wisata.index') . '?page=' . request('page', 1) }}" class="text-decoration-none text-muted">
    ...
    <div>
        <a href="{{ route('admin.wisata.index') . '?page=' . request('page', 1) }}" class="btn-interactive btn-interactive-forest btn-interactive-md">
...
<form action="{{ route('admin.wisata.update', $wisata) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mt-4 d-flex align-items-center justify-content-end gap-2 p-3 bg-white border rounded-4 shadow-sm">
        <a href="{{ route('admin.wisata.index') . '?page=' . request('page', 1) }}" class="btn btn-light border px-4 fw-semibold">Batal</a>
