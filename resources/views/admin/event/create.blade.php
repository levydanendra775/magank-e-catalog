...
<div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-4">
    <div>
        <div class="text-muted small mb-1">
            ...
            <span class="text-dark font-mono">Tambah Event</span>
        </div>
        <h4 class="fw-bold mb-0" style="color:var(--primary);">Tambah Agenda & Event Baru</h4>
    </div>

    <div>
        <a href="{{ route('admin.event.index') }}" class="btn-interactive btn-interactive-forest btn-interactive-md">
...
<form action="{{ route('admin.event.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mt-4 d-flex align-items-center justify-content-end gap-2 p-3 bg-white border rounded-4 shadow-sm">
        ...
        <button type="submit" class="btn btn-primary px-5 fw-bold shadow-sm">
            <i class="fa-solid fa-floppy-disk me-1.5"></i> Simpan Event
        </button>
    </div>
</form>
