...
<div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-4">
    <div>
        <div class="text-muted small mb-1">
            ...
            <span class="text-dark font-mono">Edit Banner</span>
        </div>
        <h4 class="fw-bold mb-0" style="color:var(--primary);">Edit Banner: {{ $banner->judul }}</h4>
    </div>

    <div>
        <a href="{{ route('admin.banner.index') }}" class="btn btn-outline-secondary px-4 me-2">
...
<form action="{{ route('admin.banner.update', $banner) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mt-4 d-flex align-items-center justify-content-end gap-2 p-3 bg-white border rounded-4 shadow-sm">
        ...
        <button type="submit" class="btn btn-primary px-5 fw-bold shadow-sm">
            <i class="fa-solid fa-pen-to-square me-1.5"></i> Update Banner
        </button>
    </div>
</form>
