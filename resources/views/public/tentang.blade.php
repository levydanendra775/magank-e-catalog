...
@section('content')
<div style="background:linear-gradient(135deg,#0a3d1f,#1a6b3a);padding:80px 0;" data-aos="fade-down">
...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm p-4 mb-4" style="border-radius:16px;" data-aos="fade-up">
            ...
            <div class="card border-0 shadow-sm p-4" style="border-radius:16px;" data-aos="fade-up" data-aos-delay="100">
                <h5 class="fw-bold mb-3" style="font-family:'Plus Jakarta Sans',sans-serif;">Kontak Kami</h5>
                <div class="d-flex flex-column gap-3">
                    <div class="d-flex gap-3 align-items-center"><div style="width:42px;height:42px;background:#e9f7ef;border-radius:10px;display:flex;align-items:center;justify-content:center;color:#1a6b3a;"><i class="fa-solid fa-location-dot"></i></div><div><div class="fw-semibold small">Alamat</div><div class="text-muted small">Plaza Ndoyo, Jl. Hasanudin No.20, Terbono, Selosari, Kec. Magetan, Kabupaten Magetan, Jawa Timur</div></div></div>
                    <div class="d-flex gap-3 align-items-center"><div style="width:42px;height:42px;background:#e9f7ef;border-radius:10px;display:flex;align-items:center;justify-content:center;color:#1a6b3a;"><i class="fa-solid fa-phone"></i></div><div><div class="fw-semibold small">Telepon</div><div class="text-muted small">(0351) 891831</div></div></div>
