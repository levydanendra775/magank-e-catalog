    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="p-4 mb-4" style="background:#fff;border:1px solid var(--border);border-radius:16px;" data-aos="fade-up">
                ...
                <p style="line-height:1.9;color:var(--text-muted);">Pesona Magetan merupakan platform digital yang dikembangkan oleh <strong style="color:var(--text-dark);">Bidang Pemasaran Dinas Pariwisata dan Kebudayaan Kabupaten Magetan</strong> sebagai media promosi dan informasi terpadu untuk destinasi wisata, event, dan berita seputar Kabupaten Magetan, Jawa Timur.</p>
